...
def prepare_data(data_dir, src_vocabulary_size, dst_vocabulary_size, recreate=False):
  ...
  data_to_tok_ids(train_path + ".lf", dst_train_ids_path, dst_vocab_path)
  ...
  data_to_tok_ids(dev_path + ".lf", dst_dev_ids_path, dst_vocab_path)
  ...
  data_to_tok_ids(test_path + ".lf", dst_test_ids_path, dst_vocab_path)

  return read_data(src_train_ids_path, dst_train_ids_path), read_data(src_dev_ids_path, dst_dev_ids_path), read_data(src_test_ids_path, dst_test_ids_path)
